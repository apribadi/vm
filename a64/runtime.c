...
noreturn void c_prim_show(void * ep, void * lp, void * sp, void * rt, uint64_t x0) {
  printf("%" PRId64 "\n", x0);

  v_kont_0(ep, lp, sp, rt);
}

noreturn void c_prim_hello(void * ep, void * lp, void * sp, void * rt) {
  (void) ep;
  (void) lp;
  (void) sp;
  (void) rt;
